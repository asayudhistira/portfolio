...
const navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    <div className='fixed inset-0 -z-10 dark:hidden'>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 
        ...
        <a href="#top">
            <Image 
              ...
              alt="" 
              className = 'w-30 cursor-pointer mr-14' /* Changed w-28 cursor-pointer mr-14*/
            />
        </a>
      ...
      top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-dark-hover 
      dark:text-white'>
